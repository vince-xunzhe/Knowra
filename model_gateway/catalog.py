...
BUILTIN_MODEL_REGISTRY = [
    ...
    {
        "id": "codex-cli/gpt-5.6-ter",
        "label": "Codex CLI / GPT-5.6-ter",
        "provider_id": "codex-cli",
        "upstream_model": "gpt-5.6-ter",
        "model_kind": "chat",
        "supports_vision": True,
        "supported_tasks": deepcopy(_CODEX_ALL_NON_EMBED_TASKS),
        "builtin": True,
    ...
    {
        "id": "codex-cli/gpt-5.6-lun",
        "label": "Codex CLI / GPT-5.6-lun",
        "provider_id": "codex-cli",
        "upstream_model": "gpt-5.6-lun",
        "model_kind": "chat",
        "supports_vision": True,
        "supported_tasks": deepcopy(_CODEX_ALL_NON_EMBED_TASKS),
        "builtin": True,
