...
def render_record_markdown(payload: dict[str, Any]) -> str:
    ...
    lines = [
        ...
        f"- Last error recoverable: `{paper.get('last_error_recoverable')}`",
        "",
...
def sync_paper_from_record(paper: Paper) -> bool:
    ...
    scalar_updates = {
        ...
        "last_error_reason": paper_block.get("last_error_reason"),
        "last_error_recoverable": paper_block.get("last_error_recoverable"),
